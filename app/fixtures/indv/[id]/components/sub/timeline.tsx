...
function TimeLine({ events }: { events: Event[] | undefined }) {
  ...
  const TimeLineDictionnary: Record<string, JSX.Element> = {
    ...
    "Own Goal": (
      <FontAwesomeIcon icon={faSoccerBall} className="text-red-500" />
    ),
  ...
  return (
    ...
    >
      <div className="p-4 text-white bg-opacity-40 bg-primary-first">
